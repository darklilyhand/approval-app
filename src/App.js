...
<style>
  ...
  td{padding:10px 14px;border:1px solid #b0d8e0;font-size:13px}
...
<table><tbody>
  ...
  <tr><td class="lb">지출 일자</td><td>${doc.fields.date||"-"}</td></tr>
  <tr><td class="lb">거래처</td><td>${doc.fields.vendor||"-"}</td></tr>
  <tr><td class="lb">상세 내역</td><td style="white-space:pre-wrap">${doc.fields.detail||"-"}</td></tr>
</tbody></table>
